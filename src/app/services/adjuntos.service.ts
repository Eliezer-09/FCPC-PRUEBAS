      ...
      if (action == "POST") {
        return this.dataService.newPostAdjunto(data, idEntidad).pipe(
          catchError((error) => {
            ...
            return of({
              error: true,
              message: "Ocurrio un error al adjuntar la cédula frontal",
            });
          })
        );
      }
        ...
        return this.dataService
          ...
          .pipe(
            catchError((error) => {
              ...
              return of({
                error: true,
                message: "Ocurrio un error al actualizar la cédula frontal",
              });
            })
          );
      }
      ...
      if (action == "POST") {
        return this.dataService.newPostAdjunto(data, idEntidad).pipe(
          catchError((error) => {
            ...
            return of({
              error: true,
              message: "Ocurrio un error al adjuntar la cédula posterior",
            });
          })
        );
      }
        ...
        return this.dataService
          ...
          .pipe(
            catchError((error) => {
              ...
              return of({
                error: true,
                message: "Ocurrio un error al actualizar la cédula posterior",
              });
            })
          );
      }
        ...
        return this.dataService.newPostAdjunto(data, idEntidad).pipe(
          catchError((error) => {
            ...
            return of({
              error: true,
              message:
                "Ocurrio un error al adjuntar el rol de pago del garante",
            });
          })
        );
      }
          ...
          .pipe(
            catchError((error) => {
              ...
              return of({
                error: true,
                message:
                  "Ocurrio un error al actualizar el rol de pago del garante",
              });
            })
          );
      }
        ...
        return this.dataService.newPostAdjunto(data, idEntidad).pipe(
          catchError((error) => {
            ...
            return of({
              error: true,
              message:
                "Ocurrio un error al adjuntar la cédula frontal del conyugue",
            });
          })
        );
      }
          ...
          .pipe(
            catchError((error) => {
              ...
              return of({
                error: true,
                message:
                  "Ocurrio un error al actualizar la cédula frontal del conyugue",
              });
            })
          );
      }
        ...
        return this.dataService.newPostAdjunto(data, idEntidad).pipe(
          catchError((error) => {
            ...
            return of({
              error: true,
              message:
                "Ocurrio un error al adjuntar la cédula posterior del conyugue",
            });
          })
        );
      }
          ...
          .pipe(
            catchError((error) => {
              ...
              return of({
                error: true,
                message:
                  "Ocurrio un error al actualizar la cédula posterior del conyugue",
              });
            })
          );
      }
      ...
      if (action == "POST") {
        return this.dataService.newPostAdjunto(data, idEntidad).pipe(
          catchError((error) => {
            ...
            return of({
              error: true,
              message: "Ocurrio un error al adjuntar el registro de propiedad",
            });
          })
        );
      }
          ...
          .pipe(
            catchError((error) => {
              ...
              return of({
                error: true,
                message:
                  "Ocurrio un error al actualizar el registro de propiedad",
              });
            })
          );
      }
      ...
      if (action == "POST") {
        return this.dataService.newPostAdjunto(data, idEntidad).pipe(
          catchError((error) => {
            ...
            return of({
              error: true,
              message: "Ocurrio un error al adjuntar el certificado predio",
            });
          })
        );
      }
        ...
        return this.dataService
          ...
          .pipe(
            catchError((error) => {
              ...
              return of({
                error: true,
                message: "Ocurrio un error al actualizar el certificado predio",
              });
            })
          );
      }
      ...
      if (action == "POST") {
        return this.dataService.newPostAdjunto(data, idEntidad).pipe(
          catchError((error) => {
            ...
            return of({
              error: true,
              message: "Ocurrio un error al adjuntar el croquis",
            });
          })
        );
      }
        ...
        return this.dataService
          ...
          .pipe(
            catchError((error) => {
              ...
              return of({
                error: true,
                message: "Ocurrio un error al actualizar el croquis",
              });
            })
          );
      }
      ...
      if (action == "POST") {
        return this.dataService.newPostAdjunto(data, idEntidad).pipe(
          catchError((error) => {
            ...
            return of({
              error: true,
              message: "Ocurrio un error al adjuntar la proforma",
            });
          })
        );
      }
        ...
        return this.dataService
          ...
          .pipe(
            catchError((error) => {
              ...
              return of({
                error: true,
                message: "Ocurrio un error al actualizar la proforma",
              });
            })
          );
      }
      ...
      if (action == "POST") {
        return this.dataService.newPostAdjunto(data, idEntidad).pipe(
          catchError((error) => {
            ...
            return of({
              error: true,
              message: "Ocurrio un error al adjuntar la liquidación Biess",
            });
          })
        );
      }
        ...
        return this.dataService
          ...
          .pipe(
            catchError((error) => {
              ...
              return of({
                error: true,
                message: "Ocurrio un error al actualizar la liquidación Biess",
              });
            })
          );
      }
      ...
      if (action == "POST") {
        return this.dataService.newPostAdjunto(data, idEntidad).pipe(
          catchError((error) => {
            ...
            return of({
              error: true,
              message: "Ocurrio un error al adjuntar la autorizacion",
            });
          })
        );
      }
        ...
        return this.dataService
          ...
          .pipe(
            catchError((error) => {
              ...
              return of({
                error: true,
                message: "Ocurrio un error al actualizar la autorizacion",
              });
            })
          );
      }
      ...
      if (action == "POST") {
        return this.dataService.newPostAdjunto(data, idEntidad).pipe(
          catchError((error) => {
            ...
            return of({
              error: true,
              message: "Ocurrio un error al adjuntar el pagare",
            });
          })
        );
      }
        ...
        return this.dataService
          ...
          .pipe(
            catchError((error) => {
              ...
              return of({
                error: true,
                message: "Ocurrio un error al actualizar el pagare",
              });
            })
          );
      }
      ...
      if (action == "POST") {
        return this.dataService.newPostAdjunto(data, idEntidad).pipe(
          catchError((error) => {
            ...
            return of({
              error: true,
              message: "Ocurrio un error al adjuntar " + nombreAdjunto,
            });
          })
        );
      }
        ...
        return this.dataService
          ...
          .pipe(
            catchError((error) => {
              ...
              return of({
                error: true,
                message: "Ocurrio un error al actualizar " + nombreAdjunto,
              });
            })
          );
      }
      ...
      if (action == "POST") {
        return this.dataService.newPostAdjunto(data, idEntidad).pipe(
          catchError((error) => {
            ...
            return of({
              error: true,
              message: "Ocurrio un error al adjuntar otros ingresos",
            });
          })
        );
      }
        ...
        return this.dataService
          ...
          .pipe(
            catchError((error) => {
              ...
              return of({
                error: true,
                message: "Ocurrio un error al actualizar otros ingresos",
              });
            })
          );
      }
      ...
      if (action == "POST") {
        return this.dataService.newPostAdjunto(data, idEntidad).pipe(
          catchError((error) => {
            ...
            return of({
              error: true,
              message: "Ocurrio un error al adjuntar el rol de pagos",
            });
          })
        );
      }
        ...
        return this.dataService
          ...
          .pipe(
            catchError((error) => {
              ...
              return of({
                error: true,
                message: "Ocurrio un error al actualizar el rol de pagos",
              });
            })
          );
      }
        ...
        return this.dataService.newPostAdjunto(data, idEntidad).pipe(
          catchError((error) => {
            ...
            return of({
              error: true,
              message:
                "Ocurrio un error al adjuntar la solicitudRefinanciamiento",
            });
          })
        );
      }
          ...
          .pipe(
            catchError((error) => {
              ...
              return of({
                error: true,
                message:
                  "Ocurrio un error al actualizar la solicitudRefinanciamiento",
              });
            })
          );
      }
