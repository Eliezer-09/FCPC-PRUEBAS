...
@Component({
  selector: 'vex-view-calificadora-riesgos',
  templateUrl: './view-calificadora-riesgos.component.html',
  styleUrls: ['./view-calificadora-riesgos.component.scss'],
  animations: [
    fadeInRight400ms,
    fadeInUp400ms,
    stagger40ms
...
export class ViewCalificadoraRiesgosComponent implements OnInit {
  ...
  asingDataToForm(){
    ...
    const controlListEntidad=["codigoSbs"]
