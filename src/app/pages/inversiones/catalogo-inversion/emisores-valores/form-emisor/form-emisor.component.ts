...
@Component({
  selector: "vex-form-emisor",
  templateUrl: "./form-emisor.component.html",
  styleUrls: ["./form-emisor.component.scss"],
  animations: [
    stagger80ms,
    fadeInUp400ms,
    scaleIn400ms,
...
export class FormEmisorComponent implements OnInit, AfterViewChecked {
