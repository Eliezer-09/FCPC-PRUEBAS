...
@Component({
  selector: 'vex-view-casa-valor',
  templateUrl: './view-casa-valor.component.html',
  styleUrls: ['./view-casa-valor.component.scss'],
  animations: [
    stagger80ms,
    fadeInUp400ms,
    fadeInRight400ms
...
export class ViewCasaValorComponent implements OnInit {
