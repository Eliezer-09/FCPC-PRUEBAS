...
/*   catalogoUrl = ApiUrl.catalogos; */
  ...
  nominatthhUrl=ApiUrlTTHH.nomina;
...
//TODO:Referencia bancaria
  ...
  postVerificaCargaBatchIngresoEgreso(data): Observable<any> {
    this.tokenvalido();
  ...
  getNominaDetalle(data): Observable<ApiResponse> {
    this.tokenvalido();
    let params = new HttpParams();
  ...
  //TODO:NOMINA
  getListadoNomina(pagina,size,idTipoColaborador?,colaborador?): Observable<ApiResponse> {
    this.tokenvalido();
    let params = new HttpParams();
