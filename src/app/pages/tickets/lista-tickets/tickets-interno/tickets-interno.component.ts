...
@Component({
  selector: "vex-tickets-interno",
  templateUrl: "./tickets-interno.component.html",
  styleUrls: ["./tickets-interno.component.scss"],
  changeDetection: ChangeDetectionStrategy.Default,
  animations: [fadeInUp400ms, stagger80ms],
})
export class TicketsInternoComponent implements OnInit, AfterViewChecked {
