...
@UntilDestroy()
@Component({
  selector: 'vex-prestamos-pagados',
  templateUrl: './prestamos-pagados.component.html',
  styleUrls: ['./prestamos-pagados.component.scss'],
...
export class PrestamosPagadosComponent implements OnInit{

  pageSize = 10;
  isLoading = true;
  infoMessage = "No se ha encontrado créditos pagados";
  term = '';
  status="Pagado";
  ...
  prestamosPagados: OperationResultPrestamo = {};
  pageEvent: PageEvent;
  filterValue: string = null;
  routers :any[]=[];

  icroundSearch        = iconify.icroundSearch;
  faMoneyCheckAlt      = iconfa.faMoneyCheckAlt ;
