...
@UntilDestroy()
@Component({
  selector: 'vex-prestamos-rechazados',
  templateUrl: './prestamos-rechazados.component.html',
  styleUrls: ['./prestamos-rechazados.component.scss'],
...
export class PrestamosRechazadosComponent implements OnInit {

  pageSize = 10;
  isLoading = true;
  infoMessage = "No se ha encontrado créditos rechazados";
  term = '';
  status="Rechazado";
  ...
  icoutlineCreditCardOff       = iconify.icoutlineCreditCardOff ;
