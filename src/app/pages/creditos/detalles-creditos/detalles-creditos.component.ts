...
/*     this.cargarComentarios(); */
  ...
  cargarEstadoPrestamo() {
    ...
    this.creditoService
      ...
      .subscribe(async (res: any) => {
        ...
        this.totalesTablaAmortizacion(this.tablaAmortizacion,this.cabecera );
     ...
     /*    if(this.estadoPrestamo=="Pendiente"){ */
      ...
      (error) => {
        ...
        this.componentService.alerta(
          "error",
          "Ocurrió un error al traer los datos del prestamo"
        );
      };
    this.creditoService
    ...
    this.dataService.getParticipeById(this.id, this.idPrestamo).subscribe(
      ...
      (error) => {
        ...
        this.componentService.alerta(
          "error",
          "Ocurrió un error al traer los datos del partícipe"
        );
      }
    );
  ...
  totalesTablaAmortizacion(tablaAmortizacion,cabecera) {
    ...
    this.totales = {
      ...
      total: this.total,
      totalInteresVencido: cabecera.totalInteresVencido
    };
  }
  ...
  postSimulacion(res){
      ...
      if(this.estadoPrestamo=="Pendiente"){ 
          this.totales = {
            ...
            totalInteresVencido: res.result.totalInteresVencido
          };
          this.cabecera = res.result;
      /*   } */
  ...
  getValidacionesCredito() {
    ...
    this.simulacionPrestamo.interesVariable = this.prestamo.interesVariable;
