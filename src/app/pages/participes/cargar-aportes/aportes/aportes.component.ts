...
import { AportesConfigure } from 'src/static-data/configure-table/participes/configure-table-aportes';
import icCheck from '@iconify/icons-fa-solid/check-circle';
import icError from '@iconify/icons-ic/highlight-off';

@UntilDestroy()
@Component({
  selector: 'vex-aportes',
...
export class AportesComponent implements OnInit,AfterViewInit{
  ...
  tableColumns: TableColumn<any>[]=AportesConfigure;
  constructor(
